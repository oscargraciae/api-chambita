...
# SubCategory.create(name: 'Carpintería', category_id: 1)
# SubCategory.create(name: 'Cerrajería', category_id: 1)
# SubCategory.create(name: 'Jardinería', category_id: 1)
# SubCategory.create(name: 'Albañilería', category_id: 1)
# SubCategory.create(name: 'Impermiabilización', category_id: 1)
# SubCategory.create(name: 'Reparación de computadoras', category_id: 1)
# SubCategory.create(name: 'Reparación de equipos electrónicos', category_id: 1)
